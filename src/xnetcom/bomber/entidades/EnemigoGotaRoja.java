...
public class EnemigoGotaRoja extends EnemigoBase {
	...
	public EnemigoGotaRoja(BomberGame context, int columna, int fila) {
		super(context, columna, fila);
		tipoEnemigo = Tipo.EN_GOTA_NARANJA;
		TiempoPorCuadro = 0.60f;
		tiempoFotograma = 83;
		TiledTextureRegion principalTR = context.getResouceManager().getGotaRojaTR().deepCopy();
	...
	*/
	...
	public EnemigoDirection seguidorSalto() {
		...
		case LEFT:
			...
			izq= context.getGameManager().getMatriz().getValor(fila, columna-5);
			try{ if (diferencia >5  && izq!=BomberGame.NADA  && izq!=BomberGame.BOMBA && izq!=BomberGame.MONEDA && izq!=BomberGame.PUERTA){dir= EnemigoDirection.NONE; return dir; }}catch (Exception e) {System.out.println("error ");}
			
			izq= context.getGameManager().getMatriz().getValor(fila, columna-6);
			try{ if (diferencia >6  && izq!=BomberGame.NADA  && izq!=BomberGame.BOMBA && izq!=BomberGame.MONEDA && izq!=BomberGame.PUERTA){dir= EnemigoDirection.NONE; return dir; }}catch (Exception e) {System.out.println("error ");}
		...
		case RIGHT:
			...
			der=context.getGameManager().getMatriz().getValor(fila, columna+5);
			try{ if (diferencia >5 && isNoSaltable(der)){dir= EnemigoDirection.NONE; return dir; }}catch (Exception e) {System.out.println("error ");}
			
			der=context.getGameManager().getMatriz().getValor(fila, columna+6);
			try{ if (diferencia >6 && isNoSaltable(der)){dir= EnemigoDirection.NONE; return dir; }}catch (Exception e) {System.out.println("error ");}
			break;
		...
		case UP:
			...
			valor =context.getGameManager().getMatriz().getValor(fila-5, columna);
			try{ if (diferencia >5 && isNoSaltable(valor)){dir= EnemigoDirection.NONE; return dir; }}catch (Exception e) {}
			
			valor =context.getGameManager().getMatriz().getValor(fila-6, columna);
			try{ if (diferencia >6 && isNoSaltable(valor)){dir= EnemigoDirection.NONE; return dir; }}catch (Exception e) {}
			break;
		...
		case DOWN:
			...
			down = context.getGameManager().getMatriz().getValor(fila+5, columna);
			try{ if (diferencia >5 && isNoSaltable(down)){dir= EnemigoDirection.NONE; return dir; }}catch (Exception e) {System.out.println("error ");}
			
			down = context.getGameManager().getMatriz().getValor(fila+6, columna);
			try{ if (diferencia >6 && isNoSaltable(down)){dir= EnemigoDirection.NONE; return dir; }}catch (Exception e) {System.out.println("error ");}
			break;

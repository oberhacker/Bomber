...
public class EnemigoMocoRojo extends EnemigoBase{
	...
	public EnemigoMocoRojo(BomberGame context, int columna, int fila) {
		super(context, columna, fila);
		tipoEnemigo = Tipo.EN_MOCO_ROJO;
		TiledTextureRegion principalTR = context.getResouceManager().getMocoRojoTR().deepCopy();
	...
	public void actualizaPosicion() {
		...
		if (valor == BomberGame.PARED ) {
			TiempoPorCuadro=0.37f;
		}
		if (valor == BomberGame.NADA) {
			TiempoPorCuadro=0.75f;
		}

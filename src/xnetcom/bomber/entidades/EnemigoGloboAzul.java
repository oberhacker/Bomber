...
public class EnemigoGloboAzul extends EnemigoBase{
	...
	public EnemigoGloboAzul(BomberGame context, int columna, int fila) {
		super(context, columna, fila);
		tipoEnemigo = Tipo.EN_GLOBO_AZUL;
		TiempoPorCuadro=0.70F*0.9f;
		tiempoFotograma=108;
		TiledTextureRegion principalTR = context.getResouceManager().getGloboAzulTR().deepCopy();

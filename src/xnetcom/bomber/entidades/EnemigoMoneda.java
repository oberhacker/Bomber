...
public class EnemigoMoneda extends EnemigoBase{

	public EnemigoMoneda(BomberGame context, int columna, int fila) {
		super(context, columna, fila);
		tipoEnemigo = Tipo.EN_MONEDA;
		TiempoPorCuadro=0.30f;
		tiempoFotograma=90;
		TiledTextureRegion principalTR = context.getResouceManager().getMonedaTR().deepCopy();
